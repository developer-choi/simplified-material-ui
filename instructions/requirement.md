...
대상 라이브러리의 복잡한 컴포넌트들을 **최소한의 기능만 남기고 단순화**하여 학습 및 이해를 돕는다.
...
- 단순화 문서 커밋: `git add docs/[카테고리]/[ComponentName]-simplified.md && git commit -m "docs: [ComponentName] 단순화 분석 문서 작성"`
- 이유:
